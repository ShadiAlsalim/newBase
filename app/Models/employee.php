...
class employee extends Model
{
    ...
    {
        return $this->belongsToMany(job_oppertunity::class, 'employee_job_opps');
    }

        public function save_job_oppertunities()
    {
        return $this->belongsToMany(job_oppertunity::class, 'save_job_oppertunities');
    }

        public function job_oppertunity_reasons()
    {
        return $this->belongsToMany(job_oppertunity::class, 'job_oppertunity_reasons');
    }

    public function employee_company()
    {
        return $this->belongsToMany(employee_company::class, 'job_oppertunity_reasons');
    }
