...
class TestingControllers extends Controller
{
    ...
    //     }
        ...
        public function pagination(Request $number){   
            $i = request('number')*10 - 9;
            for($i ;$i<=request('number')*10 ; $i++){
    ...
    //     $employee =employee::where('user_id',$user->id)->with([
    //         'city' => function ($query) {
    //             return $query->get('name');
    //         },
    //         'workExperiences' => function ($query) {
    //             return $query->leftJoin('job_titles', 'job_titles.id', '=', 'work_experiences.job_title_id');
    //         },
    //         'educationalCertificates' => function ($query) {
    //             return $query->leftJoin('education_levels', 'education_levels.id', '=', 'educational_certificates.education_level_id');
    //         },
    //     ])->first();
    ...
    //     return ['profile'=>$employee ,'language_and_levels'=> $language_and_levels];
    // }
