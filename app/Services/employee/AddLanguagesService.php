...
class AddLanguagesService
{
    public function AddLanguages ($request){
        ...
        $Language_Level = LanguageAndLevel::create([ 
          ...
          unset( $Language_Level->employee_id , $Language_Level->language_id , $Language_Level->Language_Level ,$Language_Level->language_level_id, $Language_Level->updated_at , $Language_Level->created_at); 
